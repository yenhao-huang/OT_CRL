...
if __name__ == "__main__":
    ...
    workloads_dir = f"/home/user/ramulator2/rh_study/ramulatorv2-rh_mitigations-cputraces/cputraces/"
    workload_name = os.listdir(workloads_dir)
    workloads = [os.path.join(workloads_dir, workload_name) for workload_name in workload_name]
