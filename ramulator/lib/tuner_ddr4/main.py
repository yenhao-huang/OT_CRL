...
def execute_sim(workload_path):
    config_path = os.path.join(HOME_DIR, 'configs', 'ours', 'DDR4', 'DDR4-config.cfg')
...
def change_sim(config):
    i_path = os.path.join(HOME_DIR, 'configs', 'ours', 'DDR4', 'DDR4-sample.cfg')
    o_path = os.path.join(HOME_DIR, 'configs', 'ours', 'DDR4', 'DDR4-config.cfg')
    map_config_path = {
