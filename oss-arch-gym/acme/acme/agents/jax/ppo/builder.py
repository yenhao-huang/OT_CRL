...
class PPOBuilder(
  ...
  def make_dataset_iterator(
    ...
    """
    # iterator_batch_size default = batch_size 
  ...
  def make_learner(
    ...
    return learning.PPOLearner(
        ...
        reg_method=self._config.reg_method,
        is_bc=self._config.is_bc,
        only_bc=self._config.only_bc,
        expertdata_path=self._config.expertdata_path,
        bc_cost = self._config.bc_cost,
        end_explore_updateidx = self._config.end_explore_updateidx,
    )
